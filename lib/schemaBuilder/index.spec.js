...
describe("The schemaBuilder module", function() {
  ...
  it("generates the findAll schema for the User model", function() {
    ...
    expect(children).to.have.length(11);
    ...
    expect(children).to.have.deep.property("[7].key", "updatedQuery");
    expect(children).to.have.deep.property("[8].key", "ageQuery");
    expect(children).to.have.deep.property("[9].key", "nested.stuffQuery");
    expect(children).to.have.deep.property("[10].key", "nested.otherStuffQuery");
  });
